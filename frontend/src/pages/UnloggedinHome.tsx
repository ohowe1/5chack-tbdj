  ...
  return (
    <DefaultLayout>
      ...
      <img src="/bountee.svg" alt="Logo" className="h-20 mb-5" />
          ...
          <p className='mx-2 mb-4 text-center'>Login with your college email account to get started with Bountee, get connected with fellow students, complete your first Bountees, and get paid!</p>
          <Button 
            as={Link} 
            href="/login"
